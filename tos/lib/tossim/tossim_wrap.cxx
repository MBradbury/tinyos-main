...
SWIGINTERN PyObject *_wrap_Packet_setDsn(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  Packet *arg1 = (Packet *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
...
SWIGINTERN PyObject *_wrap_Packet_dsn(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  Packet *arg1 = (Packet *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args,"Packet_dsn",0,0,0)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(self, &argp1, SWIGTYPE_p_std__shared_ptrT_Packet_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyMethodDef SwigPyBuiltin__Packet_methods[] = {
  ...
  { "setDsn", (PyCFunction) _wrap_Packet_setDsn, METH_O, (char *) "" },
  { "dsn", (PyCFunction) _wrap_Packet_dsn, METH_NOARGS, (char *) "" },
  { NULL, NULL, 0, NULL } /* Sentinel */
};
